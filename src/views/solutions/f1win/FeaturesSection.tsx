...
const FeaturesSection = ({}: Props) => {
  ...
  const features = [
    {
      label: t('solutionsPage.connectionManagement'),
      descriptions: [
        t('solutionsPage.ensureSecureAndControlledAccess'),
        t('solutionsPage.accessAuthentication'),
        t('solutionsPage.ipWhitelisting'),
      ],
    },
    {
      label: t('solutionsPage.orderDeliveryWithCustomFepIntegration'),
      descriptions: [
        t('solutionsPage.speedAndFlexibilityInRouting'),
        t('solutionsPage.dedicatedFrontEndProcesses'),
        t('solutionsPage.multiFepConnectivity'),
      ],
    },
    {
      label: t('solutionsPage.preTradeOrderValidation'),
      descriptions: [
        t('solutionsPage.tradeWithComplianceAndDescription'),
        t('solutionsPage.orderEligibilityChecks'),
        t('solutionsPage.riskAwarePreprocessing'),
      ],
    },
    {
      label: t('solutionsPage.systemInterfaces'),
      descriptions: [
        t('solutionsPage.keepOfflineInformationInSync'),
        t('solutionsPage.ledgerIntegration'),
        t('solutionsPage.positionCalculatorSupport'),
      ],
    },
    {
      label: t('solutionsPage.advancedMonitoring'),
      descriptions: [
        t('solutionsPage.keepTradeWindowsProactiveControl'),
        t('solutionsPage.performanceMonitoring'),
        t('solutionsPage.riskMonitoring'),
      ],
    },
    {
      label: t('solutionsPage.operationalRiskControls'),
      descriptions: [
        t('solutionsPage.protectAgainstSystemicThreats'),
        t('solutionsPage.killSwitch'),
        t('solutionsPage.excessiveQuoteProtection'),
        t('solutionsPage.limitManagement'),
      ],
    },
  ];
