  ...
  return (
    <section className="about-section bg-grey-200 sm:!py-[60px]  xs:py-[30px] ">
      <MainWrapper>
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-3 md:grid-rows-2 xs:rounded-none  sm:!rounded-2xl  xs:mt-[2rem] md:!mt-[5rem] bg-white md:gap-0 overflow-hidden">
