...
const timelineData: TimelineItem[] = [
  {
    ...
    items: [
      ...
      'Development of global currency PR system',
    ],
  },
  {
    year: '2020',
    items: [
      'Development of arbitrage transaction and order management for Security traders',
      'Eurex Prisma Margin calculation solution development and SPAN',
  ...
  {
    year: '2018',
    items: ['Development of message distribution/sending system', 'Development of OMS system'],
  },
  {
    year: '2017',
    items: [
      'Development of domestic & global derivatives integration HTS, MTS, and ledger system',
      'Development of Hanoi exchange future ledger system for Vietnam Security',
    ],
  },
  {
    year: '2016',
    items: [
      'Development of PC Client platform Presto',
      'Development of global future option portfolio margin calculation solution Prima',
    ],
  },
  {
    year: '2015',
    items: ['Adopt Viance mobile platform and take over Mich-in Co.'],
  },
  {
    year: '2014',
    items: [
      ...
      'Development of global stock (16 exchanges) HTS with SunGard in partnership',
      'Transferred global future option market data vendor and IDC Partnership to GeminiSoft Co.',
    ],
  },
  {
    year: '2013',
  ...
  },
  {
    year: '2011',
    items: [
      "Development of FIX SME 3.0 Interface solution and qualification of CME Group's ISV Independent Software Vendor",
  ...
  {
    year: '2008',
    items: ['Development of domestic/global future option integration ledger'],
  },
  {
    year: '2007',
    items: ['Development of global future option non-electronic ledger system'],
  },
  {
    year: '2006',
    items: [
      'Establishment of technical research institute of Winway System Co.',
      'Development of margin FX equation for Broker and Dealers',
    ],
  },
  {
    year: '2004',
    items: ['Began ASP and development of global future system', 'Winway System was founded'],
  },
];
...
const TimelineSection = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const purpleLine = timelineRef.current?.querySelector('.timeline-line-purple');
      if (purpleLine) {
        gsap.fromTo(
          purpleLine,
          {
        ...
        <div className="text-center mb-12 md:mb-16">
          <h3
            ...
            dangerouslySetInnerHTML={{
              __html: t('companyPage.companyHistory'),
            }}
          />
        </div>
            ...
            {timelineData.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Year */}
                    <h3 className="title-year text-[2rem] md:text-[2.5rem] leading-[2.5rem] md:leading-[3rem] font-bold bg-gradient-to-b from-[#6F77DA] to-transparent bg-clip-text text-transparent mb-3 md:mb-4">
                      {item.year}
                    </h3>
