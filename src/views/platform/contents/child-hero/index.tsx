  ...
  return (
    <section className="hero-section relative w-screen xs:h-[750px] sm:!h-[800px] overflow-hidden sm:w-screen transition-all duration-500 ease-in-out">
      <div className="hero-bg absolute top-0 left-0 w-full h-full  animate-translateY bg-no-repeat">
        <img
          src="/images/pages/platform/en/platform-bg-2.jpg"
          ...
          <div className="flex xs:flex-col items-center sm:!flex-row justify-between gap-6">
            <div className="flex-1 flex xs:flex-col">
              <p className="text-nd-600 text-[1.125rem] leading-[1.75rem] font-normal  mb-[0.625rem]">
                {currentPlatform?.num + ' - ' + currentPlatform?.label}
              </p>
              <h1
                ...
                dangerouslySetInnerHTML={{
                  __html: currentPlatform?.title || '',
                }}
              />
              <p className="text-white text-[1.125rem] leading-[1.75rem] font-normal">
            ...
            <div className="flex-1">
              <img
                ...
                src="/images/pages/platform/en/platform-bg-item-1.jpg"
              />
            </div>
          </div>
        </MainWrapper>
