...
const HeroSection = ({}: Props) => {
  ...
  return (
    <section className="hero-section w-screen xs:h-screen xsm:!h-screen sm:w-screen relative ">
      ...
      <div className="w-full absolute top-[100px] left-1/2 transform  -translate-x-1/2  z-[3] ">
        <MainWrapper isFullContainer nameClass="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Button className="w-[2.5rem] h-[2.5rem]  hover:!bg-gradient-primary transition-all duration-300 !bg-transparent !rounded-full  !border !border-primary-400 !border-solid">
              <HeroIcons.Play
                size={10}
                pathProps={{
                  stroke: 'white',
            ...
            <p className="text-[0.75rem] leading-[1.125rem] text-white font-medium uppercase">
              Showreel
            </p>
          </div>
          <div className="flex flex-col gap-2 text-right items-end">
            <h6 className="flex items-center gap-2 text-primary-600 font-medium text-[2.25rem] leading-[3rem]">
              250+
              <HeroIcons.ArrowRightUp
                size={18}
                pathProps={{
            ...
            <p className="text-[0.75rem] leading-[1.125rem] text-white font-[500]">
              full-time professionals on staff
            </p>
          </div>
        </MainWrapper>
      </div>
      ...
      <div className="xs:w-full sm:!w-auto xs:max-w-full xs:min-w-[90%] md:!min-w-[800px] sm:!max-w-[800px] hero-intro absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[3] flex xs:flex-col md:!flex-row xs:items-center md:!items-end xs:justify-start sm:!justify-end px-4 xs:gap-8 sm:gap-0">
        <div>
          ...
          >
            Software Delivery Driving Business Growth
          </h1>
          <h6 className="mt-[0.875rem] xs:text-center md:!text-left font-normal md:text-[1.125rem] text-white sm:leading-[1rem] md:!leading-[1.75rem]">
