...
import LanguageDropdown from '../../shared/sections/config-language';
...
const AppBarContentVertical = (props: AppBarContentProps) => {
  const { settings, saveSettings, toggleNavVisibility, apiMainData, navVisible } = props;
  ...
  return (
    <AppBarContent>
      ...
      <RightAction>
        ...
        <IconButton color="inherit" sx={{ mr: 0, pr: 0, p: 0 }} onClick={toggleNavVisibility}>
          {!navVisible ? (
