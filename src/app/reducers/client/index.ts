...
export const searchAll: any = createAsyncThunk('appClients/searchAll', async (param, thunkAPI) => {
...
export const getSubInfo = createAsyncThunk('appClients/getSubInfo', async () => {
  return getSubInfoService();
});

export const getMainInfo = createAsyncThunk('appClients/getMainInfo', async () => {
...
export const getCategories = createAsyncThunk('appClients/getCategories', async () => {
...
export const getTermDetail: any = createAsyncThunk('appClients/getTermDetail', async () => {
  return getTermDetailService();
});

export const getPolicyDetail: any = createAsyncThunk('appClients/getPolicyDetail', async () => {
